...
export const GET: RequestHandler = async ({ params }) => {
    // Decodificamos la URL por si la imagen tiene espacios (ej: "mi foto.avif" -> "mi%20foto.avif")
    ...
    try {
        ...
        // Imprimir el error exacto en los logs del contenedor para depurar
        console.error(`[ERROR] SvelteKit no pudo leer la imagen en disco: ${fullPath}`, err);
        throw error(404, 'Imagen no encontrada en disco');
    }
};
